...
$settings['apass']='ilmulino135';

/* Website title */
$settings['website_title']="Il Mulino di Praiano";

/* Website URL */
$settings['website_url']='http://www.domain.com/';

/* Guestbook title */
$settings['gbook_title']="Il Mulino di Praiano Guestbook";

/* Your e-mail address. */
$settings['admin_email']='design@tspeaker.com';

/* URL of the gbook.php file. */
$settings['gbook_url']='http://www.ilmulinodipraiano.com/ita/guestbook/gbook.php';

/* If you want to use a logical anti-SPAM question type it here */
$settings['spam_question']='Type <b>VILLA</b> below to show you are not a robot:';

/* Correct answer to the anti-SPAM logical question */
$settings['spam_answer']='VILLA';
...
$settings['logfile']='ilmulinogb.txt';
